...
static const YYINT yydefred[] = {                         0,
    ...
    7,    3,    0,    0,   21,    0,    0,    0,   16,    0,
   18,   20,   19,    8,    5,   15,   13,   11,
};
#if defined(YYDESTRUCT_CALL) || defined(YYSTYPE_TOSTRING)
static const YYINT yystos[] = {                           0,
  256,  257,  260,  266,  267,  268,  269,  270,  272,  273,
  260,  268,  259,  261,  262,  263,  264,  271,  276,  274,
  257,  257,  257,  272,  260,  276,  257,  275,
};
#endif /* YYDESTRUCT_CALL || YYSTYPE_TOSTRING */
static const YYINT yydgoto[] = {                          4,
    5,    6,    7,    8,   18,    9,   10,   20,   28,   19,
};
static const YYINT yysindex[] = {                      -239,
 -241,    0,    0,    0, -239,    0,    0, -253,    0,    0,
    0,    0, -250, -237,    0, -235, -234, -247,    0, -233,
    0,    0,    0,    0,    0,    0,    0,    0,
};
...
static const YYINT yygindex[] = {                         0,
    0,   21,    0,    0,    0,   10,    0,    0,    0,   11,
};
#define YYTABLESIZE 29
static const YYINT yytable[] = {                         10,
   10,   10,   10,   10,   10,   13,   21,   14,   15,   16,
   17,   13,   25,   14,   15,   16,    1,    2,   11,   22,
    3,   23,    2,   27,    1,   12,   24,   17,   26,
};
static const YYINT yycheck[] = {                        259,
  260,  261,  262,  263,  264,  259,  257,  261,  262,  263,
  264,  259,  260,  261,  262,  263,  256,  257,  260,  257,
  260,  257,  257,  257,    0,    5,   17,  260,   18,
};
#if YYBTYACC
...
"NEWLINE","LESS","AMPS","APPEND","PIPE","$accept","goal","commands","command",
"simple_command","piped_command","iomodifier_opt_list","command_and_args",
"command_word","arg_list","argument","iomodifier_opt","illegal-symbol",
};
